...
from fin.calculators.holdings import calculate_holdings, get_signed_quantity
...
class TestHoldingsCalculator:
    ...
    def test_get_signed_quantity_buy(self):
        ...
        row = pd.Series(
            {"Action": "Buy", "Quantity": 100, "Amount": 1500.0, "Source": "Test", "Note": ""}
        )
    ...
    def test_get_signed_quantity_sell(self):
        ...
        row = pd.Series(
            {"Action": "Sell", "Quantity": 50, "Amount": 800.0, "Source": "Test", "Note": ""}
        )
